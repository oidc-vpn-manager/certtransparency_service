...
class JSONFormatter(logging.Formatter):
    ...
    def format(self, record):
        ...
        log_entry = {
            ...
            'service': 'oidc-vpn-manager-certtransparency',
            'version': '1.0',
        }
...
def setup_logging(app_config: Dict[str, Any] = None) -> None:
    ...
    if app_config and app_config.get('ENVIRONMENT') == 'development':
        ...
        config['loggers']['app.app']['handlers'].append('console')
...
def configure_security_logging(app):
    ...
    app.logger.info("Certificate Transparency service startup", extra={
        'event_type': 'system_startup',
        'service': 'certtransparency',
        'version': '1.0',

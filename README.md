# Certificate Transparency Service for OpenVPN-Manager
...
This service is typically accessed via the [frontend service](https://github.com/openvpn-manager/frontend_service), but can also be exposed separately for automated queries.
